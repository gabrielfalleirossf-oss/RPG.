...
const ORIGENS = {
  Nerd:{imagem:"../../../assets/origens/nerd.png?v=23",descricao:"Um jovem extremamente focado nos estudos. Sua busca incansável por conhecimento cobrou um preço: alimentação ruim, nenhuma atividade física e um corpo pouco saudável.",pericias:{Medicina:2,"Sobrevivência":1,"Percepção":3,"Investigação":1},atributos:{presenca:3,apt_magica:2,forca:-2,agilidade:-2,resistencia:-2}},
  Lutador:{imagem:"../../../assets/origens/lutador.png?v=23",descricao:"Desde cedo encontrou sua paixão nas artes marciais e fez do treino uma obsessão. Seu corpo tornou-se uma arma letal e um escudo impenetrável, mas seu crescente ceticismo o fez acreditar que tudo pode ser resolvido com os punhos.",pericias:{Esquiva:2,HtH:3,Bloqueio:2},atributos:{agilidade:2,forca:1,apt_magica:-4}},
  Bodybuilder:{imagem:"../../../assets/origens/bodybuilder.png?v=23",descricao:"Encontrou na academia sua própria forma de superação. Treina de maneira obstinada, transformando o corpo enquanto ignora dores e articulações sobrecarregadas. Não acredita no sobrenatural: acredita apenas em si mesmo.",pericias:{Bloqueio:3,Vontade:3,Iniciativa:1},atributos:{forca:3,resistencia:2,agilidade:-2,apt_magica:-3}}
};
