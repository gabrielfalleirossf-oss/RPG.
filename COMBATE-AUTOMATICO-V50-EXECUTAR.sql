...
begin
  ...
  if ator_tipo='personagem' then
    ...
    bonus:=coalesce((p.bonus_pericias->>pericia)::integer,0);
  ...
  evento:=jsonb_build_object('tipo','resolucao','defensor_lado',lado_ator,'defensor_nome',nome_ator,'defesa_pericia',pericia,
