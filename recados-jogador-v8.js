window.iniciarRecadosJogadorV8=async function(){
 const auth=window.RPG_AUTH,rpg=document.body.dataset.rpg;if(!auth||auth.perfil!=="jogador"||document.querySelector(".recado-overlay"))return;
